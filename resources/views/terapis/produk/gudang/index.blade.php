...
<div class="card">
    <div class="card-body">
        <h3 class="card-title" style="font-size: 1.5rem; font-weight: bold; color: #000;">Data Produk Gudang</h3>
    </div>
    <div class="card-body">
        ...
        <div class="row mb-3 align-items-center justify-content-between">
            ...
            <div class="col-md-9 d-flex flex-wrap align-items-center gap-2">
                ...
                <!-- Form Filter -->
                <form action="{{ route('terapis.produk.index', $posisi) }}" method="GET" class="form-inline d-flex flex-wrap align-items-center">
            ...
            <table id="example1" class="table" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Edit -->
                            <a href="{{ route('terapis.produk.edit', ['posisi' => strtolower($data->posisi), 'id' => $data->id]) }}" class="text-success" title="Edit">
                            ...
                            <form id="deleteForm{{ $data->id }}" action="{{ route('terapis.produk.destroy', ['posisi' => strtolower($data->posisi), 'id' => $data->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
