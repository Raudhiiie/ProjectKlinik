                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <!-- -- Edit -- -->
                            <a href="{{ route('terapis.terapis.edit', ['terapi' => $data->id]) }}" class="text-success" title="Edit">
                            ...
                            <form id="deleteForm{{ $data->id }}" action="{{ route('terapis.terapis.destroy', ['terapi' => $data->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
